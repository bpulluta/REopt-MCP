...
- `b`: float, diesel fuel burn rate intercept coefficient (y = m*x + b*rated\_capacity) [gal/kwh/kw]
- `m`: float, diesel fuel burn rate slope (y = m*x + b*rated\_capacity) [gal/kWh]
